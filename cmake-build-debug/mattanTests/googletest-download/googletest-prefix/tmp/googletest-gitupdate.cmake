...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/cs/usr/oren_gerc/OS/OS-ex3-MapReduce/cmake-build-debug/mattanTests/googletest-main'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/cs/usr/oren_gerc/OS/OS-ex3-MapReduce/cmake-build-debug/mattanTests/googletest-main'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
